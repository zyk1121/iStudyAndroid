package com.example.zhangyuanke.istudyandroid.FCJar;
...
public class FCJarActivity extends BaseActivity {

    private WebView webView = null;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fcjar);

        webView = (WebView)findViewById(R.id.jni_jar_view);
...
则两个调用都可以显示正常的html网页了，并且前一种可以对针对不同分辨率大小的屏幕做缩放了！！
        * */
        ...
        String htmlPath = "/storage/sdcard0/AndroidJar.html";
        String dataStr = null;
        try {
        ...
        String baseUrl = "file:///storage/sdcard0/123/";
